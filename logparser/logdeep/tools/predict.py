...
from logparser.dataset.sample import session_window, sliding_window
from logparser.logdeep.dataset import log_dataset
        ...
        with torch.no_grad():
            for idx, line in tqdm(enumerate(data_iter)):
                ...
                data_loader = DataLoader(
                    dataset, batch_size=min(len(dataset), 128), shuffle=True, pin_memory=True
                )
